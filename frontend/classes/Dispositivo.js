        ...
        codigoHTML+='<div class="modal-dialog modal-dialog-scrollable" role="document">'
            codigoHTML+='<div class="modal-content">'
                ...
                codigoHTML+='<div class="modal-body">'
                    codigoHTML+='<p>Faça a leitura do código QR abaixo com seu dispositivo celular para efetuar a configuração básica! Atenção é necessário acesso a internet para gerar o QRCode desta funcionalidade!</p>'
                    codigoHTML+='<div class="qrcode rounded mx-auto d-block" id="qr" style="margin-top: 30px;" align="middle"></div>'
